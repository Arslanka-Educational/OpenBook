...
set JARPATH=%APP_HOME%\lib\core-catalog-writer.jar

@rem Execute core-catalog-writer
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CORE_CATALOG_WRITER_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%CORE_CATALOG_WRITER_EXIT_CONSOLE%" exit 1
exit /b 1
